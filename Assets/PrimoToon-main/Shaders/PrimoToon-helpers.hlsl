...
vector<half, 4> calculateEnvLighting(vector<float, 3> vertexWSInput){
    ...
    Light l1 = GetAdditionalLight(0, vertexWSInput, half4(1,1,1,1));
    Light l2 = GetAdditionalLight(1, vertexWSInput, half4(1,1,1,1));
    Light l3 = GetAdditionalLight(2, vertexWSInput, half4(1,1,1,1));
    Light l4 = GetAdditionalLight(3, vertexWSInput, half4(1,1,1,1));
    ...
    vector<half, 3> firstPointLight = l1.color * (l1.distanceAttenuation * l1.shadowAttenuation);
    vector<half, 3> secondPointLight = l2.color * (l2.distanceAttenuation * l2.shadowAttenuation);
    vector<half, 3> thirdPointLight = l3.color * (l3.distanceAttenuation * l3.shadowAttenuation);
    vector<half, 3> fourthPointLight = l4.color * (l4.distanceAttenuation * l4.shadowAttenuation);
